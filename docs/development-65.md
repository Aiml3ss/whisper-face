...
| 18 | Selective Re-listen of uncertain spans | active | Native-timing-only selector merges action/payload spans, caps two 2.4-second microspans, rejects full utterances, and downgrades unsafe rolling-chunk timing; execution stays disabled until item 19 supplies a killable process boundary and measured accuracy |
