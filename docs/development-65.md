...
| 14 | End-to-end component prewarming/cold-start elimination | active | Closed numeric traces and 20 sample-aware cold/warm guardrails cover audio pool, Tiny, final ASR, Ollama, and total readiness; caller labels are not physical proof, so controlled cold-cache and steady-state Mac evidence remains |
