...
$Required = @(
    ...
    "shadow_candidate_gate.py", "measurement_mode.py",
    ...
    "whisper_face_gui.py", "whisper_face_theme.py",
    ...
    "icons\faces\tiger-idle.svg", "icons\faces\tiger-blink.svg", "icons\faces\tiger-talk.svg",
