...
export const RELEASE = {
  ...
  dmg: 'https://github.com/Aiml3ss/whisper-face/releases/download/v0.1.0/WhisperFace-0.1.0-macOS-arm64.dmg',
  size: '2.6 MB',
  notes: 'https://github.com/Aiml3ss/whisper-face/releases/tag/v0.1.0',
  checksums:
    'https://github.com/Aiml3ss/whisper-face/releases/download/v0.1.0/SHA256SUMS',
  /**
